...
if (TYPO3_MODE == 'BE') {
	...
	$TCA['pages']['columns']['module']['config']['items'][] = array(
		'LLL:EXT:'.$_EXTKEY.'/Resources/Private/Language/locallang_db.xlf:tca.pages.module.items.bricks',
		bricks,
		\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($_EXTKEY).'Resources/Public/Backend/Icons/bricks.png'
	);
	\TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon(
		'pages',
		'contains-bookaddresses',
		\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($_EXTKEY).'Resources/Public/Backend/Icons/bookaddresses.png'
	);
	$TCA['pages']['columns']['module']['config']['items'][] = array(
		'LLL:EXT:'.$_EXTKEY.'/Resources/Private/Language/locallang_db.xlf:tca.pages.module.items.bookaddresses',
		bookaddresses,
		\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath($_EXTKEY).'Resources/Public/Backend/Icons/bookaddresses.png'
	);
}
